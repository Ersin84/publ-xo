...
export const SINGLE: SinglePageType = {
  ...
  title: "Jeder Kunde ist herzlich willkommen",
  desc: "Jeder Kunde ist herzlich willkommen und sich in guter Gesellschaft befindet. Dabei vertritt unser Kunden aus ganz Wien.   Fortschnitt Frisuren - 1040 Wien - Rechte Wienzeile 15 - Naschmarkt",
  date: "May 20, 2023",
  ...
  author: {
    ...
    firstName: "Mimi",
    lastName: "Fones",
    displayName: "Iulian Ghepes",
    email: "info.wromo@gmail.com",
    avatar: a10,
    count: 38,
    href: "/author/the-demo-author-slug",
    desc: "Manager and Developer - I find the best options for website apps or Ads, and I improve them daily to reach the best result.",
    jobName: "Author Job",
  },
  categories: [
    {
...
export const SINGLE_VIDEO: SinglePageType = {
  ...
  title: "Art of Video a direct perspective",
  desc: "Jeder Kunde ist herzlich willkommen und sich in guter Gesellschaft befindet. Dabei vertritt unser Kunden aus ganz Wien.   Fortschnitt Frisuren - 1040 Wien - Rechte Wienzeile 15 - Naschmarkt",
  date: "May 20, 2023",
  href: "/single/this-is-single-slug",
  commentCount: 14,
