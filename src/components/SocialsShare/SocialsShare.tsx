...
const socials: SocialType[] = [
  { id: "Facebook", name: "Facebook", icon: "lab la-facebook-f", href: "https://www.facebook.com/wromomerkant" },
  { id: "Twitter", name: "Twitter", icon: "lab la-twitter", href: "https://twitter.com/WromoShop" },
  { id: "Linkedin", name: "Linkedin", icon: "lab la-linkedin-in", href: "https://www.linkedin.com/in/wromo-team-a7413b210/" },
