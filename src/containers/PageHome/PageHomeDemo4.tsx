...
const MAGAZINE1_TABS = ["all", "Farben", "Haarbehandlung", "Styling", "Waschen",  "Fone", "Augenbrauen", "modelrasieren"];
...
const PageHomeDemo4: React.FC = () => {
  ...
  return (
    <div className="nc-PageHomeDemo4 relative">
      <Helmet>
        <title>Blog || FORTSCHNITT Frisuren - Wien 1040</title>
      </Helmet>
      ...
      <div className="relative">
        <SectionHero2
          ...
          youtubeID="pHEuhYVSGjc"
          rightImg="https://i.ibb.co/4t4CLCD/creative-video-Adobe-Express.gif"
          heading="Fortschnitt Frisuren - 1040 Wien - Rechte Wienzeile 15 - Naschmarkt"
          subHeading="Top-Friseur Wien - Rechte Wienzeile 15 - Naschmarkt
           nur mit Termin - jetzt Reservierungsanfrage
           Entdecken Sie den neuen Look, den Sie suchen - wien 1040."
        />
