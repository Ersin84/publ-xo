...
const SingleContentDemo = () => {
  return (
    <>
      ...
      <p>
        Next generation content delivery and Ads. The automation of ads and website apps, by indexing not only words but also videos that are the most accessed today... and in a big constant increase in views. And a better understanding of the product or service offered. Because the majority of buyers or consumers ... do not have time to read thousands of written content websites ... to capture in a much faster way and in a short time the content and meanings or settings of the product or services on the market global.
      </p>
      <p>
      ...
      <figure>
        <img
          src="https://i.ibb.co/r6vgBgW/blog-wromo.jpg"
          alt="nc blog"
        />
        <figcaption>
          Next generation content delivery and Ads. Iure vel
